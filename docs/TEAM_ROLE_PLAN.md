...
> **2026-08-30 구현 상태 주의:** 역할 경계는 이 문서가 정본이지만 진행률은
> `PROJECT_STATUS.md`를 따른다. A RTL/SoC/PS 합류와 B v04 데모 후보 반영이 완료됐으며,
> 최신 보드·카메라 Closed-loop 검증은 아직 남아 있다.
...
**2026-08-26 C 갱신: KY-008 수령품 100 ms 단발과 수동 재무장 실물 확인 완료.**
...
**인원:** 3명  
**진척 기록 갱신:** 2026-08-26 (§17 — A Phase 4 기록 + C KY-008 독립 단발. 역할 경계 변경 없음)
**역할 난이도:** A 상 / B 중 / C 중
