...
> 기준점: 2026-08-27 B model_v03 최종 전달 + A Phase 4 기록 + C KY-008 단발 완료
>
> 최종 검증: 2026-08-27, B v03 자체검증·A 회신 18/18 + C TB 12개/KY-008 결과
>
...
전체 시스템 기준으로는 A 실제 산출물 합류와 Camera/NPU Closed-loop 검증이 남아 있다.
...
| 우선순위 | 요청 | 영향 | 담당 |
|---:|---|---|---|
| 1 | A 실제 RTL/PS 소프트웨어 브랜치 합류 | B v03·C 실제 모듈과 `top_system/npu_axi` 통합 | A |
...
| 7 | CR C-002 Event Window + Webcam Fallback 검토 | v03 Dataset/Golden 재생성 필요 여부 | A/B |
...
- B: v03 전달 상태를 유지하고 A 시간 일관성 Gate 및 CR C-002 Window 실측 회신을 기다린다.
